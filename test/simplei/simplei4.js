...
function simpleiDefaultStart() {
  ...
  for (var i = 0; i <= imageCount-1; i++)
    ...
    document.write('<a href="004_events_church_workday_sep_2013.html?', i, '">', '<img name="simplei', i,  '" src="', thumb[i], '" border=20></a>')
    }
  }
  ...
  if( number<imageCount)
    {
      currentImage=number;
      //link
      document.write('<a href="004_events_church_workday_sep_2013.html">');
      //image

...
function simpleiDefaultStart() {
  ...
  for (var i = 0; i <= imageCount-1; i++)
    ...
    document.write('<a href="003_events_conference_Vienna_Easter_2013.html?', i, '">', '<img name="simplei', i,  '" src="', thumb[i], '" border=20></a>')
    }
  }
  ...
  if( number<imageCount)
    {
      currentImage=number;
      //link
      document.write('<a href="003_events_conference_Vienna_Easter_2013.html">');
      //image
